    ...
    <div className="relative min-h-[82vh] flex flex-col items-center justify-center px-4 py-8 sm:py-12 text-center animate-fade-in overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl mx-auto mb-6">
        ...
        <h1 className="font-serif text-4xl sm:text-6xl md:text-7xl font-bold tracking-[0.14em] text-[#faf5eb] uppercase leading-tight">
          HUNT THE <span className="gold-gradient-text drop-shadow-[0_4px_24px_rgba(212,175,55,0.4)]">EDIT</span>
        </h1>
        ...
        <p className="mt-3 text-sm sm:text-base text-[#ebd9c0] max-w-xl mx-auto leading-relaxed font-light">
          Five signature bottles are meticulously concealed inside each royal scene.
          Scan the heritage interiors and tap every bottle before time runs out.
        </p>
      </div>

      {/* Hero Visual: The authentic supplied bottle image */}
      <div className="relative z-10 my-4 sm:my-6 group flex justify-center">
        <div className="relative p-2.5 rounded-2xl bg-gradient-to-b from-[#1a0c06]/90 via-[#100603]/90 to-[#070302]/90 border border-[#d4af37]/45 shadow-[0_25px_60px_rgba(0,0,0,0.95)]">
          {/* Subtle Ambient Halo */}
          ...
          <div className="absolute bottom-4 left-1/2 -translate-x-1/2 px-3 py-1 rounded-full bg-[#0a0503]/85 border border-[#d4af37]/50 backdrop-blur-md whitespace-nowrap">
            <span className="text-[10px] font-mono tracking-[0.2em] text-[#f7e7a9] uppercase font-bold">
              5 HIDDEN BOTTLES PER SCENE
            </span>
          </div>
        </div>
      </div>
